...
const areas = [
  ...
  },
  {
    ...
    metaKeywords: "نقل عفش الأحمدي, نقل اثاث الفحيحيل, نقل عفش المنقف, نقل اثاث أبو حليفة, نقل عفش الصباحية, نقل اثاث الرقة, نقل عفش هدية, نقل اثاث الظهر, نقل عفش الوفرة, نقل اثاث الزور, نقل عفش الخيران, نقل اثاث المهبولة, نقل عفش الفنطاس, نقل اثاث العقيلة",
    neighborhoodDetails: [
      {
        name: "الفحيحيل",
