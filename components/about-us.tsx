        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground">
              <p>
                تأسست شركة بشاير الخير لنقل الأثاث منذ أكثر من 10 سنوات، وخلال هذه الفترة اكتسبنا خبرة كبيرة في مجال نقل
              ...
              <p>
                ...
                بحالة ممتازة. لدينا أسطول من السيارات المجهزة خصيصاً لنقل الأثاث بأمان تام.
              </p>
              <p>
                ...
                <div className="bg-white/90 backdrop-blur-sm p-6 rounded-lg shadow-lg">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <p>خبرة أكثر من 10 سنوات في مجال نقل الأثاث</p>
                    </div>
