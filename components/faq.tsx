...
const faqs = [
  {
    question: "ما هي أوقات عمل شركة بشاير الخير لنقل العفش؟",
    answer:
      "شركة بشاير الخير لنقل العفش تعمل على مدار 24 ساعة طوال أيام الأسبوع، لتلبية احتياجات العملاء في أي وقت. يمكنك التواصل معنا في أي وقت للحصول على خدماتنا.",
    category: "أوقات العمل",
  },
  {
    question: "كم تستغرق عملية نقل العفش منزل كامل؟",
    answer:
      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <p className="max-w-[700px] text-muted-foreground md:text-lg">
            نجيب على استفساراتكم الشائعة حول خدمات نقل العفش والتغليف
          </p>
        </div>
