...
const testimonials = [
  {
    ...
    text: "تعاملت مع شركة بشاير الخير لنقل الأثاث وكانت تجربة رائعة. الفريق محترف جداً والتزموا بالموعد المحدد. قاموا بفك وتركيب الأثاث باحترافية عالية وحافظوا على كل قطعة. أنصح بالتعامل معهم وسأتعامل معهم مرة أخرى بالتأكيد.",
    service: "نقل أثاث منزلي",
  },
  {
    id: 2,
    name: "فاطمة العنزي",
        ...
        >
          <div className="relative z-10">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              نسعى دائماً لتقديم أفضل خدمة ممكنة لعملائنا الكرام. اتصل بنا اليوم واحصل على تجربة نقل أثاث مميزة.
            </p>
